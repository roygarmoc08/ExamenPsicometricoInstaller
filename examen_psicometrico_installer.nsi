...
!define PRODUCT_NAME "ExamenPsicometrico"
...
Icon ".\pixmaps\psicometrico.ico"
!define MUI_ICON ".\pixmaps\psicometrico.ico" 
...
; The setup filename
OutFile "examen-psicometrico-${VERSION}.exe"

; The default installation directory
InstallDir $PROGRAMFILES\ExamenPsicometrico

; Registry key to check for directory (so if you install again, it will 
; overwrite the old one automatically)
InstallDirRegKey HKLM "Software\ExamenPsicometrico" "Install_Dir"
...
Section "ExamenPsicometrico (required)"
  ...
  WriteRegStr HKLM       "${UNINSTALL_REGKEY}" "DisplayIcon" "$INSTDIR\pixmaps\psicometrico.ico"
